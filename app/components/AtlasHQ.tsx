      ...
      return (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span style={{ fontSize: 13, fontFamily: "monospace", letterSpacing: "0.12em", color: "rgba(255,255,255,0.35)", flexShrink: 0 }}>CONFIDENCE</span>
            <div
            ...
            <span style={{ fontSize: 13, fontFamily: "monospace", fontWeight: 700, color: confColor, flexShrink: 0 }}>{item.confidence}%</span>
          </div>
          {sourcesOpen && (
