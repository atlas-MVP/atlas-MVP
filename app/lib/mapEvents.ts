...
export const MAP_EVENTS: Record<string, MapEvent> = {
  ...
  "october-7": {
    ...
    steps: [
      {
        flyTo: { center: [34.5, 31.5], zoom: 9, duration: 2000 },
      ...
      },
      {
        popup: {
          ...
          body: "364 people killed at an outdoor music festival near Re'im. The deadliest single site of the attack.",
          sourceLabel: "Reuters",
        },
        narration: "Approximately 1,200 people are killed — over 250 taken hostage",
        hold: 5000,
      },
      {
        dismissPopup: true,
        flyTo: { center: [34.44, 31.50], zoom: 10, duration: 1500 },
        strikes: [
      ...
      {
        flyTo: { center: [35.5, 33.2], zoom: 7, duration: 2500 },
        highlight: ["LBN"],
